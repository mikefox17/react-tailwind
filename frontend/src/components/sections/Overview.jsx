            ...
            <div className='lg:grid grid-rows-3 grid-flow-col space-x-8  rounded-lg'>
                ...
                <div className='col-span-2'>
                    <p className='text-xl text-gray-600 text-center mb-4 lg:mb-0'>
                        Why hello there! My name is Mike Fox and I am a full
                        stack developer with a background in hospitality.
                        Checkout my portfolio, its still a work in progress.
                        This site is built with react, tailwind, vite, and
                        sanity. I'm using netlify to host this project! I left
                        the restaurant industry and decided to pursue the world
                        of technology. So I completed a fullstack coding
                        bootcamp at George Washington University. I recently
                        started creating youtube tutorials to help document my
                        coding journey
                    </p>
                </div>
